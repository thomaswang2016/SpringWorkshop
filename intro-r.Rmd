...
ggplot(data = diamonds, aes(x =total , y = price, color=color)) +
  geom_line() +
  geom_point()
...
Whatever you do, please don't post your assigned questions onto paid answer-sharing services. That's a violation of the Communitydi Standard as well as a very poor way to learn to use R.  
